...
class AttachControlBtnWin(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.attachcc_v2open_button.setEnabled(False)
        ...
        self.attachcc_v2close_button.setEnabled(False)
        ...
        self.attachcc_pumpinopen_button.setEnabled(False)
        ...
        self.attachcc_pumpinclose_button.setEnabled(False)
        ...
        self.attachcc_pumpoutopen_button.setEnabled(False)
