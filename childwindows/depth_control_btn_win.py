...
class DepthControlBtnWin(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        # 窗口设置
        self.setFixedSize(460, 320)  # 设置窗体大小
        ...
        self.dmctl_both_ballast_silder.setMinimum(-25)#设置最小值
        self.dmctl_both_ballast_silder.setMaximum(25)#设置最大值
        self.dmctl_both_ballast_silder.setSingleStep(1)#设置步长值
        self.dmctl_both_ballast_silder.setValue(0)#设置当前值
        ...
        self.dmctl_both_ballast_silder.setFixedSize(150,30)
        ...
        self.depth_mannual_control_layout.addWidget(self.dmctl_both_ballast_value_label, 0, 5, 1, 1, QtCore.Qt.AlignCenter)
        self.dmctl_both_ballast_value_label.setFixedSize(50,50)

        self.dmctl_both_ballast_button = QtWidgets.QPushButton('发送数据')
        self.depth_mannual_control_layout.addWidget(self.dmctl_both_ballast_button, 0, 6, 1, 1, QtCore.Qt.AlignCenter)
        ...
        self.dmctl_left_ballast_silder.setMinimum(-25)#设置最小值
        self.dmctl_left_ballast_silder.setMaximum(25)#设置最大值
        self.dmctl_left_ballast_silder.setSingleStep(1)#设置步长值
        self.dmctl_left_ballast_silder.setValue(0)#设置当前值
        ...
        self.dmctl_left_ballast_silder.setFixedSize(150,30)
        ...
        self.depth_mannual_control_layout.addWidget(self.dmctl_left_ballast_value_label, 1, 5, 1, 1, QtCore.Qt.AlignCenter)
        self.dmctl_left_ballast_value_label.setFixedSize(50,50)

        self.dmctl_left_ballast_button = QtWidgets.QPushButton('发送数据')
        self.depth_mannual_control_layout.addWidget(self.dmctl_left_ballast_button, 1, 6, 1, 1, QtCore.Qt.AlignCenter)
        ...
        self.dmctl_right_ballast_silder.setMinimum(-25)#设置最小值
        self.dmctl_right_ballast_silder.setMaximum(25)#设置最大值
        self.dmctl_right_ballast_silder.setSingleStep(1)#设置步长值
        self.dmctl_right_ballast_silder.setValue(0)#设置当前值
        ...
        self.dmctl_right_ballast_silder.setFixedSize(150,50)
        ...
        self.depth_mannual_control_layout.addWidget(self.dmctl_right_ballast_value_label, 2, 5, 1, 1, QtCore.Qt.AlignCenter)
        self.dmctl_right_ballast_value_label.setFixedSize(50,30)

        self.dmctl_right_ballast_button = QtWidgets.QPushButton('发送数据')
        self.depth_mannual_control_layout.addWidget(self.dmctl_right_ballast_button, 2, 6, 1, 1, QtCore.Qt.AlignCenter)
        self.dmctl_right_ballast_button.setFixedSize(80,30)

        #self.dmctl_left_ballast_button.setObjectName("SET_PUMP_OUT_OFF")
        ...
        # self.attachcc_pumpoutclose_button.setEnabled(False)
